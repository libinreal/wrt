    ...
    <div class="section clearfix">
	    <div class="page-vertical">
			<div class="breadcrumbs">
				<a href="../mall/">首页</a> &gt; <a href="index.html">基建商城</a> &gt; <span>收货地址</span>
				<a href="javascript:history.go(-1);" class="return">返回 &gt;</a>
			</div>
	    	<div class="address-list" style="display: none;">
	    		<div id="zj-list"></div>
				<div class="address-button">
					<a class="btn button btn-secondary big" href="address-add.html" id="add-address-btn">新增</a>
					<a class="btn button btn-secondary big" href="#" id="next-btn" style="margin-left: 15px;">下一步</a>
				</div>
	    	</div>
...
<!--[for(i=0;i<list.length;i++){]-->
	<div class="address-item clearfix" data-id="<!--[=list[i].id]-->">
		...
		<a class="address-operate <!--[=(list[i].default==1?'active':'')]-->" href="#"></a>
	</div>
<!--[}]-->
</script>
...
<script>
	seajs.use('../content/js/mall/address');
</script>
</body>
</html>
