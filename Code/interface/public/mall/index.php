...
<div class="index_header">
    <div class="index_header_f clearfix">
      <div class="logo"><a hidefocus="true" href="/"><img alt="物融通" src="../content/images/common/top_logo.jpg"></a></div>
      <div class="hd-search">
        <div class="search-bd">
          <div class="search-i">
            <form name="search" action="../mall/search.html">
              <div class="search-button">
                <button type="submit" class="btn-search s-search"><i></i></button>
              </div>
              <div class="search-combobox">
                <div class="search-combobox-input">
                       <input id="skey" name="key" placeholder="请输入关键词查询" value="">        
                </div>
              </div>
            </form>
          </div>
	...
	<div style="width:1000px;height:40px;position:relative;margin:0 auto;">
		...
		<div style="width:300px;height:300px;position:absolute;right:0;top:50px;z-index:2;">
			...
			<div class="jj_notice">
				...
				<div id="zj-notice"><div class="nodata">暂无数据。</div></div>
			</div>
		</div>
	</div>
	<div class="banner">
