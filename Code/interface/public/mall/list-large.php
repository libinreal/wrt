...
<div class="section">
	<div class="page-vertical large-list">
		<ul class="large_page_bottom" id="zj-list"></ul>
	</div>
</div><!--//section-->
...
<script id="zj-navi-tmpl" type="text/html">
	...
	<!--[}else{]-->
	<a href="list-large.html?code=<!--[= list[i].code]-->"><!--[= list[i].name]--></a> &gt;
	<!--[}]-->
	<!--[}]-->
	</div>
...
<script id="zj-list-tmpl" type="text/html">
	...
	<li class="clearfix">
		...
		<div class="large-info">
			...
			<!--[}]--></label>
			<label><span class="cj-name">厂家：</span><span class="cj-length"><!--[= list[i].factoryName || '--']--></span><span class="left_margin_c">提货地点：</span><!--[= list[i].shiplocal]--><span class="left_margin_c">可销售数量：</span><font class="font-color"><!--[= list[i].storeNum]--></font> <!--[= list[i].unit]--></label>
		</div>
...
<script>
	seajs.use('../content/js/mall/list-large');
</script>
</body>
</html>