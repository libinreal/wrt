...
<div class="section page-vertical">
	<div class="breadcrumbs">
		<a href="../mall/">首页</a> &gt; <a href="index.html">个人中心</a> &gt; <a href="my-order.html">我的订单</a> &gt; <span id="type-name">订单对账</span>
		<a href="javascript:history.go(-1);" class="return">返回 &gt;</a>
	</div>
	<div class="twoforyou">
		<div class="order" id="zj-detail"></div>
		<div class="confirm-ok clearfix" style="display: none;">
			<span>请仔细核对本批次清单内容</span>
			<a href="javascript:;" class="button btn-primary confirm-order">确认无误</a>
		</div>
	</div>
</div><!--//section-->
		...
		<div class="pdt-list">
			...
			<!--[for(i = 0; i < orders.length; i ++) {]-->
				<div class="pdt-list-content clearfix">
					...
					<div class="goods-button" style="<!--[= orders[i].status == '3' ? 'display: block;' : 'display: none;']-->"><a class="button btn-secondary btn-yanshou" href="#" data-id="<!--[= id]-->">确认验收</a></div>
			...
			<!--[}]-->
			<div class="confirm-other"><img src="../content/images/wrt/bill.png" width="350" height="150"/></div>
		</div>
	</div>
	</div>
...
<script src="../content/js/module/tools.scrollable/jquery.tools.scrollable.min.js"></script>
<script>
	seajs.use('../content/js/personal/main');
	seajs.use('../content/js/personal/my-order-reconciliations');
</script>
