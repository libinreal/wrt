	<div id="sidepanel" class="hide" style="right: 118.5px; bottom: 65px;">
		<a href="#" id="gotop" class="gotop" title="返回顶部"></a>
	</div>
<div class="footer">
    <div class="nav">
        <ul class="page-vertical clearfix">
            ...
            <a href="../news/">物融新闻</a></li><li>
            <a href="../help/common-page.html?type=about">关于我们</a></li>
        </ul>
    </div>
    <div class="helper">
...
<script id="zj-ad-tmpl" type="text/html">
