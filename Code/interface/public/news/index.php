...
<div class="section content-news">
	<div class="page-vertical">
		<div class="content-top clearfix">
			...
			<div class="notice">
				<div class="left clearfix"><h3>公告栏</h3><a class="leftspan" href="../notice/list.html">更多 ></a></div>
				<ul id="zj-notice"></ul>
			</div>
		</div>
...
<script id="zj-notice-tmpl" type="text/html">
	...
	<li>
	    <a class="<!--[= (i == list.length - 1) ? 'last' : '']-->" href="../notice/detail.html?type=<!--[= list[i].catType]-->&id=<!--[= list[i].id]-->" title="<!--[= list[i].title]-->">
...
<script id="zj-news-tmpl" type="text/html">
	...
	<!--[if (i == 0){]-->
	<li class="top">
		<div class="list-img"><a href="detail.html?type=<!--[= type]-->&id=<!--[= list[i].id]-->"><img src="<!--[= $absImg(list[i].imgurl)]-->" width='156px' height='111px'/></a></div>
        <h1><a href="detail.html?type=<!--[= type]-->&id=<!--[= list[i].id]-->" title="<!--[= list[i].title]-->"><!--[= list[i].title]--></a></h1>
        <p title="<!--[= list[i].brief]-->"><!--[= $ellipsis(list[i].brief,32)]--></p>
	</li>	
	<!--[}else{]-->
