...
elseif ($_REQUEST['act'] == 'update') {
    ...
    if($GLOBALS['db']->query($sql)) {
        admin_log('信用池介绍', 'edit', 'credit_intrinfo');   // 记录管理员操作
        clear_cache_files();    // 清除缓存
        $link[] = array('text' => $_LANG['back_list'], 'href' => 'credit_intrinfo.php?act=edit&id=1');
