...
$_LANG['advertis'][''] = '请选择';
$_LANG['advertis'][1] = '定制专区-首页';
$_LANG['advertis'][2] = '物融新闻-首页';
$_LANG['advertis'][3] = '物融新闻-媒体声音';
$_LANG['advertis'][4] = '物融新闻-品牌新闻';
$_LANG['advertis'][5] = '物融新闻-市场活动';
$_LANG['advertis'][6] = '积分商城-首页';
$_LANG['advertis'][7] = '基建商城-首页';
$_LANG['advertis'][8] = '信用池-首页';
$_LANG['advertis'][9] = '信用池-信用评测';
$_LANG['advertis'][10] = '信用池-了解更多';
$_LANG['advertis'][11] = '公告-商城公告';
$_LANG['advertis'][12] = '公告-定制专区';
$_LANG['advertis'][13] = '公告-积分公告';
$_LANG['advertis'][14] = '公告区-广告';
$_LANG['advertis'][15] = '数据智能-广告';
$_LANG['advertis'][16] = '移动物融-广告';
$_LANG['advertis'][17] = '钢材钢绞线系列-广告';
$_LANG['advertis'][18] = '水泥、沥青、混凝土外加剂系列-广告';
$_LANG['advertis'][19] = ' 锚具、锚杆系列-广告';
$_LANG['advertis'][20] = '支座、伸缩缝、止水带系列-广告';
$_LANG['advertis'][21] = '土工材料、塑料管材系列-广告';
$_LANG['advertis'][22] = '工程机械、交通设施系列-广告';
$_LANG['advertis'][23] = '科技产品系列-广告';
$_LANG['advertis'][24] = '物融通顶部--右侧单图广告';
//$_LANG['advertis'][25] = '公告-积分公告-右侧3';
...
/* JS语言提示 */
$_LANG['js_languages']['posit_name_empty'] = '广告位不能为空!';
