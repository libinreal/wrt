...
$_LANG['back_list'] = '返回积分商品分类列表';
$_LANG['continue_add'] = '继续添加积分商品分类';
...
$_LANG['catadd_succed'] = '新积分商品分类添加成功!';
$_LANG['catedit_succed'] = '积分商品分类编辑成功!';
$_LANG['catdrop_succed'] = '积分商品分类删除成功!';
$_LANG['catremove_succed'] = '积分商品分类转移成功!';
$_LANG['move_cat_success'] = '转移积分商品分类已成功完成!';

$_LANG['cat_move_desc'] = '什么是转移积分商品分类?';
...
$_LANG['cat_move_notic'] = '在添加积分商品或者在积分商品管理中,如果需要对积分商品的分类进行变更,那么你可以通过此功能,正确管理你的积分商品分类。';

$_LANG['cat_move_empty'] = '你没有正确选择积分商品分类!';
