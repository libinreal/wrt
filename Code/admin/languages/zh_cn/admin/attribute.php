...
/* 列表 */
$_LANG['by_goods_type'] = '按物料类型显示：';
$_LANG['all_goods_type'] = '所有物料类型';
...
$_LANG['attr_type'] = '购买物料时是否需要选择该属性的值';
$_LANG['attr_code'] = '属性编码';
...
$_LANG['label_cat_id'] = '所属物料类型：';
$_LANG['label_attr_index'] = '能否进行检索：';
$_LANG['label_is_linked'] = '相同属性值的物料是否关联？';
...
$_LANG['no_attr_values'] = "规格名与规格编码之间用英文状态下的逗号‘,’进行分割，且每个规格值必须有规格编码";
$_LANG['no_select_arrt'] = '您没有选择需要删除的属性名';
$_LANG['drop_ok'] = '成功删除了 %d 条物料属性';

$_LANG['js_languages']['name_not_null'] = '请您输入属性名称。';
$_LANG['js_languages']['values_not_null'] = '请您输入该属性的可选值。';
$_LANG['js_languages']['cat_id_not_null'] = '请您选择该属性所属的物料类型。';
