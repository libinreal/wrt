...
$_LANG['area_id'] = '选择区域';
$_LANG['region_name'] = '销售区域';
$_LANG['goods_name'] = '商品名称';
$_LANG['goods_suppliers'] = '厂商';
$_LANG['goods_attri'] = '规格/型号/材质';
$_LANG['goods_pub_time'] = '发布时间';
$_LANG['goods_sn'] = '货号';
$_LANG['shop_price'] = '交易价格';
$_LANG['is_on_sale'] = '上架';
$_LANG['goods_number'] = '库存';
$_LANG['market_price'] = '出厂价格';
$_LANG['copy'] = '复制';
$_LANG['item_list'] = '货品列表';
$_LANG['shiplocal'] = '发货地点';
$_LANG['integral'] = '积分额度';
$_LANG['on_sale'] = '上架';
...
$_LANG['selected_area'] = '选择区域';
$_LANG['selected_All'] = '全部地区';
...
$_LANG['invalid_goods_category'] = '物料分类不是最底层分类，不可添加商品';
...
$_LANG['js_languages']['no_selected_area'] = '没有选择区域,请选择区域';
