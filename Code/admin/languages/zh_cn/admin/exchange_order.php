...
$_LANG['os'][OS_SPLITING_PART] = '发货';

$_LANG['ss'][SS_UNSHIPPED] = '未发货';
$_LANG['ss'][SS_PREPARING] = '配货中';
$_LANG['ss'][SS_SHIPPED] = '已发货';
$_LANG['ss'][SS_RECEIVED] = '收货确认';
$_LANG['ss'][SS_SHIPPED_PART] = '已发货';
...
$_LANG['goods_name_brand'] = '商品名称';
$_LANG['goods_sn'] = '货号';
$_LANG['goods_price'] = '积分额度';
$_LANG['goods_number'] = '兑换数量';
$_LANG['goods_attr'] = '属性';
...
/* 订单操作 */
$_LANG['exchange_order_operate'] = '订单操作：';
