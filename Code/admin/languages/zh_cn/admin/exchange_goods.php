...
$_LANG['edit_exchange_goods'] = '编辑积分商品信息';
$_LANG['copy_exchange_goods'] = '复制积分商品信息';
$_LANG['continue_add_goods'] = '继续添加新商品';
$_LANG['back_goods_list'] = '返回商品列表';
$_LANG['add_goods_ok'] = '添加积分商品成功。';
$_LANG['edit_goods_ok'] = '编辑积分商品成功。';
$_LANG['trash_goods_ok'] = '把积分商品放入回收站成功。';
$_LANG['restore_goods_ok'] = '还原积分商品成功。';
$_LANG['drop_goods_ok'] = '删除积分商品成功。';
$_LANG['batch_handle_ok'] = '批量操作成功。';
$_LANG['drop_goods_confirm'] = '您确实要删除该商品吗？';
$_LANG['batch_drop_confirm'] = '彻底删除积分商品将删除与该积分商品有关的所有信息。\n您确实要删除选中的积分商品吗？';
$_LANG['trash_goods_confirm'] = '您确实要把该积分商品放入回收站吗？';
$_LANG['trash_product_confirm'] = '您确实要把该货品删除吗？';
$_LANG['batch_trash_confirm'] = '您确实要把选中的积分商品放入回收站吗？';
$_LANG['restore_goods_confirm'] = '您确实要把该积分商品还原吗？';
$_LANG['batch_restore_confirm'] = '您确实要把选中的积分商品还原吗？';
$_LANG['batch_on_sale_confirm'] = '您确实要把选中的积分商品上架吗？';
$_LANG['batch_not_on_sale_confirm'] = '您确实要把选中的积分商品下架吗？';
$_LANG['batch_best_confirm'] = '您确实要把选中的积分商品设为精品吗？';
$_LANG['batch_not_best_confirm'] = '您确实要把选中的积分商品取消精品吗？';
$_LANG['batch_new_confirm'] = '您确实要把选中的积分商品设为新品吗？';
$_LANG['batch_not_new_confirm'] = '您确实要把选中的积分商品取消新品吗？';
$_LANG['batch_hot_confirm'] = '您确实要把选中的积分商品设为热销吗？';
$_LANG['batch_not_hot_confirm'] = '您确实要把选中的积分商品取消热销吗？';
$_LANG['cannot_found_goods'] = '找不到指定的积分商品。';
$_LANG['sel_goods_type'] = '请选择积分商品类型';
...
$_LANG['notice_goods_sn'] = '如果您不输入一个积分商品货号，系统将自动生成一个唯一的货号。';
...
$_LANG['notice_storage'] = '积分商城商品的库存数';
$_LANG['notice_keywords'] = '用空格分隔';
$_LANG['notice_user_price'] = '会员价格为-1时表示会员价格按会员等级折扣率计算。你也可以为每个等级指定一个固定价格';
$_LANG['notice_goods_type'] = '请选择积分商品的所属类型，进而完善积分此商品的属性';

$_LANG['on_sale_desc'] = '打勾表示允许积分兑换，否则不允许积分兑换。';
