...
$_LANG['label_parent_name'] = '上级会员名称';
$_LANG['label_company'] = '所在公司';
...
$_LANG['qq'] = 'QQ';
$_LANG['weixin'] = '微信账号';
$_LANG['companyName'] = '单位名称';
$_LANG['department'] = '所在部门';
$_LANG['position'] = '职位';
$_LANG['companyAddress'] = '单位地址';
$_LANG['officePhone'] = '办公电话';
$_LANG['fax'] = '办公传真';
$_LANG['projectName'] = '项目名称';
$_LANG['projectBrief'] = '项目简介';
$_LANG['contacts'] = '联系人';
$_LANG['contactsPhone'] = '联系人手机号码';
$_LANG['secondContacts'] = '第二联系人';
$_LANG['secondPhone'] = '第二联系人电话';
$_LANG['customNo'] = '会员编码';
$_LANG['customerNo'] = '买方客户号';
$_LANG['customerAccount'] = '买方账号';
$_LANG['customLevel'] = '会员级别';
$_LANG['credit_rank'] = '信用等级';
$_LANG['msn'] = 'MSN';
$_LANG['home_phone'] = '家庭电话';
$_LANG['office_phone'] = '办公电话';
$_LANG['mobile_phone'] = '手机';
$_LANG['user_privilege'] = '会员权限';

$_LANG['customLevelNo'][0] = "注册会员";
$_LANG['customLevelNo'][1] = '交易会员' ;
$_LANG['customLevelNo'][2] = 'VIP下单会员' ;


$_LANG['privilege'][1] = '验章权限' ;
$_LANG['privilege'][2] = '验收权限' ;
$_LANG['privilege'][3] = '支付权限' ;
...
$_LANG['batch_remove_successArr'] = '已经成功删除了 %s 会员账号。';
...
$_LANG['js_languages']['no_position'] = '职位不能为空。';
$_LANG['js_languages']['no_companyName'] = '单位名称不能为空。';
$_LANG['js_languages']['no_companyAddress'] = '单位地址不能为空。';
$_LANG['js_languages']['no_contacts'] = '联系人不能为空。';
$_LANG['js_languages']['no_contactsPhone'] = '联系人电话不能为空。';
?>
