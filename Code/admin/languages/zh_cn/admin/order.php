...
$_LANG['order_split'] = '订单拆分';
$_LANG['postscript'] = '备注';
$_LANG['cs'][-1] = '请选择';
$_LANG['cs'][OS_UNCONFIRMED] = '已提交';
$_LANG['cs'][OS_CONFIRMED] = '确认中';
$_LANG['cs'][OS_ACCOUNT] = '对账中';
$_LANG['cs'][OS_COMPLETE] = '完成';
$_LANG['cs'][OS_CANCELED] = '取消';
$_LANG['cs'][OS_INVALID] = '无效';

$_LANG['invType'][0] = '增值税专用发票';
$_LANG['invType'][1] = '普通发票';
/* 订单状态 */
$_LANG['os'][OS_SUBMIT] = '已提交';//-1
$_LANG['os'][OS_UNCONFIRMED] = '已确认';//0
$_LANG['os'][OS_CONFIRMED] = '处理中';//1
$_LANG['os'][OS_ACCEPT] = '验收中';//2
$_LANG['os'][OS_ACCOUNT] = '对账中';//3
$_LANG['os'][OS_COMPLETE] = '完成';//4
$_LANG['os'][OS_CANCELED] = '<span style="color: #cc3300;"> 取消</span>';//5
$_LANG['os'][OS_INVALID] = '<span style="color: #cc3300;">无效</span>';//6

// 子订单状态
$_LANG['cos'][OS_CHILD_ORDER] = '已保存'; // -1
$_LANG['cos'][COS_UNCONFIRMED] = '已提交'; //0
$_LANG['cos'][COS_CONFIRMED] = '待支付';//1
$_LANG['cos'][COS_ACCEPT] = '确认支付';//2
$_LANG['cos'][COS_ACCOUNT] = '待验收';//3
$_LANG['cos'][COS_COMPLETE] = '确认验收';//4
$_LANG['cos'][COS_CANCELED] = '完成';//5
...
$_LANG['detail'] = '查看';
$_LANG['split_orders'] = '拆分';
$_LANG['split_orders_info'] = '拆分订单';
$_LANG['contract_sn'] = '合同编号';
$_LANG['suborders'] = '查看子订单';
$_LANG['phone'] = '电话';
$_LANG['group_buy'] = '（团购）';
...
/*子订单列表*/
$_LANG['suborders_list'] = '子订单列表';
$_LANG['no_orders'] = '暂时还没有订单记录';
$_LANG['no_suborders'] = '还没有任何拆分记录';
$_LANG['remarks_save_ok'] = '编辑备注成功';
/* 订单搜索 */
