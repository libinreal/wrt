...
$_LANG['suppliers_code'] = '供货商编码';
$_LANG['area_name'] = '所在区域';
$_LANG['suppliers_area_name'] = '请选择区域';
...
$_LANG['notice_admins'] = '如果管理员绑定了其他供货商就不再这里显示';
$_LANG['suppliers_name_exist'] = '该供货商名称已存在，请您换一个名称';
$_LANG['suppliers_admins_exist'] = '请选择一个管理员或先添加一个管理员作为绑定管理员';
/* 系统提示 */
...
$_LANG['js_languages']['no_suppliers_code'] = '供货商编码必须填写';
$_LANG['js_languages']['no_area_name'] = '区域必须选择';
?>