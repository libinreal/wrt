    ...
    <div class="list-div" id="listDiv">
        ...
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            <tr>
                ...
                <th><?php echo $this->_var['lang']['code']; ?></th>
                <th><?php echo $this->_var['lang']['wcode']; ?></th>
...
?>
            <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
                ...
                <td width="10%"><?php echo $this->_var['cat']['code']; ?></td>
                <td width="10%"><?php echo $this->_var['cat']['wcode']; ?></td>
