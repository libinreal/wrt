...
?>
            <tr>
                ...
                <td class="first-cell" style="text-align: center;">
                    <?php if ($this->_var['goods']['region_name'] == '中国'): ?>全部区域<?php else: ?><?php echo htmlspecialchars($this->_var['goods']['region_name']); ?><?php endif; ?>
                ...
                <td style="text-align: right;"><span onclick="listTable.edit(this, 'edit_market_price', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['market_price']; ?></span></td>
            ...
            <!--
                ...
                <td align="center">
                    ...
                    <a href="goods.php?act=edit&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?><?php endif; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" width="16" height="16" border="0" /></a>
                    <!--
                    <a href="goods.php?act=copy&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?><?php endif; ?>" title="<?php echo $this->_var['lang']['copy']; ?>"><img src="images/icon_copy.gif" width="16" height="16" border="0" /></a>
                    -->
    ...
    <div>
        ...
        <!--
        <select name="target_cat" id="target_cat" onchange="get_target_cat();" style="display:none">
            <option value="0" level="0"><?php echo $this->_var['lang']['select_please']; ?></option><?php echo $this->_var['cat_list']; ?>
        </select>
...
//    function get_target_cat() {
//        var obj = document.getElementById('target_cat');
