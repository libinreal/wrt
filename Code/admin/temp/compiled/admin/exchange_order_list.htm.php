...
<!-- 订单列表 -->
<form method="post" action="exchange_order.php?act=operate" name="listForm" onsubmit="return check()">
...
?>
            <tr>
                <td valign="top" nowrap="nowrap">
                    <!--<input type="checkbox" name="checkboxes" value="<?php echo $this->_var['order']['order_sn']; ?>" />-->
                    <a href="exchange_order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>" id="order_<?php echo $this->_var['okey']; ?>">
                ...
                <td align="left" valign="top">
                    <a href="mailto:<?php echo $this->_var['order']['email']; ?>"> <?php echo htmlspecialchars($this->_var['order']['consignee']); ?></a><?php if ($this->_var['order']['tel']): ?> <span>&nbsp;电话: <?php echo htmlspecialchars($this->_var['order']['tel']); ?><?php endif; ?> <span></span><br />
                ...
                <td align="center" valign="top" nowrap="nowrap">
                    <?php echo $this->_var['lang']['os'][$this->_var['order']['order_status']]; ?>,
                    <!--
                    <?php echo $this->_var['lang']['ps'][$this->_var['order']['pay_status']]; ?>,
                    -->
                    <?php echo $this->_var['lang']['ss'][$this->_var['order']['shipping_status']]; ?>
                </td>
                <td align="center" valign="top"  nowrap="nowrap">
                    <a href="exchange_order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>"><?php echo $this->_var['lang']['detail']; ?></a>
                </td>
            </tr>
...
function show_order_goods(e, order_id, layer_id)
{
    ...
    else
    {
        ...
        Ajax.call('exchange_order.php?is_ajax=1&act=get_goods_info&order_id='+order_id, '', response_goods_info , 'POST', 'JSON');
    }
}
