...
<form method="post" action="order.php?act=operate" name="listForm" onsubmit="return check()">
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            <tr>
                <th>
                    <a href="javascript:listTable.sort('delivery_sn', 'DESC'); "><?php echo $this->_var['lang']['label_delivery_sn']; ?></a><?php echo $this->_var['sort_delivery_sn']; ?>
                </th>
...
?>
            <tr>
                <td valign="top" nowrap="nowrap"><?php echo $this->_var['delivery']['delivery_sn']; ?></td>
                ...
                <td align="center" valign="top"  nowrap="nowrap">
                    <a href="exchange_order.php?act=delivery_info&delivery_id=<?php echo $this->_var['delivery']['delivery_id']; ?>"><?php echo $this->_var['lang']['detail']; ?></a>
                </td>
            </tr>
