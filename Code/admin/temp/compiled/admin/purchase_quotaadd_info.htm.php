        ...
        <td id="state">
            <span>
                <?php if ($this->_var['info']['status'] == 0): ?>
                    ...
                    <a href="javascript:void(0);" class="state_a" listid="<?php echo $this->_var['info']['id']; ?>" style="text-decoration: underline;color: red; "><?php echo $this->_var['lang']['accept_purchase_quotaadd']; ?></a>
                <?php elseif ($this->_var['info']['status'] == 1): ?>
                   <?php echo $this->_var['lang']['success_purchase_quotaadd']; ?>
                <?php endif; ?>
            </span>
        </td>
    </tr>
    ...
    function update_state(id,remark1){
        $.ajax({
            ...
            'success':function(msg){
                msg = $.parseJSON(msg);
                if(msg.status == 1){
                    $('#state').text('<?php echo $this->_var['lang']['success_purchase_quotaadd']; ?>');
                    $('.td-remark').show();
