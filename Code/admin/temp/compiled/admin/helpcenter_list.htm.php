...
<form method="POST" action="helpcenter.php?act=batch_remove" name="listForm">
    <!-- start cat list -->
...
?>
            <tr>
                ...
                <!--<td align="center"><?php if ($this->_var['list']['article_type'] == 0): ?><span><?php echo $this->_var['lang']['common']; ?></span><?php else: ?><span style="color: red;"><?php echo $this->_var['lang']['top']; ?></span><?php endif; ?></td>-->
                ...
                <td align="center" nowrap="true">
                    <span>
                    <!--<a href="../helpcenter.php?id=<?php echo $this->_var['list']['article_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16" /></a>&nbsp;-->
                    <a href="helpcenter.php?act=edit&id=<?php echo $this->_var['list']['article_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
                    <!--<?php if ($this->_var['list']['article_id'] != 43): ?>-->
                    <!-- <?php if ($this->_var['list']['cat_id'] > 0): ?> -->
                    <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['article_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a>
                    <!-- <?php endif; ?> -->
                    <!--<?php endif; ?>-->
                </span>
...
?>
     ...
     */
    function catChanged(){
        var obj = document.forms['listForm'].elements['target_cat'];
        cat_type = obj.options[obj.selectedIndex].getAttribute('cat_type');

        if ((obj.selectedIndex > 0) && (cat_type == 1000 || cat_type == 2000)){
            alert(not_allow_add);
            obj.selectedIndex = 0;
            return false;
        }
