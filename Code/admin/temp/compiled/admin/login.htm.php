...
<div class="loginBox">
    <div class="login_area">
        <form id="login" action="privilege.php" method="post" name="myform" onsubmit="return fnGetLogin();">
            <div class="login_logo"></div>
            <div class="input_text">
                <input name="username" type="text" placeholder="输入管理员"/>
...
<div class="bg"><img src="/admin/images/admin-bg.png"></div>
<div class="Copyright">Copyright <?php echo $this->_var['DataYear']; ?> 中交物融集成服务平台有限公司   版权所有</div>
...
//                return false;
//            }
//            //chk_null($('.input_text input').eq(0));
//            //chk_null($('.input_text input').eq(1));
//            $(this).submit();
//        });
//    });
