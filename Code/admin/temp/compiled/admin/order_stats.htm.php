...
<div class="form-div">
    ...
    <form action="" method="post" id="selectForm" name="selectForm">
        ...
        <!--<?php $_from = $this->_var['start_date_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'start_date_0_54511500_1446432903');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['start_date_0_54511500_1446432903']):
?>-->
        <?php if ($this->_var['k'] > 0): ?>
        &nbsp;+&nbsp;
        <?php endif; ?>
        <input name="year_month[]" value="<?php echo $this->_var['start_date_0_54511500_1446432903']; ?>" style="width:60px;" onclick="return showCalendar(this, '%Y-%m', false, false, this);" />
...
<div class="tab-div">
    <div id="tabbar-div">
        <p>
            <span class="tab-front" id="order_circs-tab"><?php echo $this->_var['lang']['order_circs']; ?></span>
            <!--
            <span class="tab-back" id="shipping-tab"><?php echo $this->_var['lang']['shipping_method']; ?></span>
            <span class="tab-back" id="pay-tab"><?php echo $this->_var['lang']['pay_method']; ?></span>
            -->
        </p>
    </div>
    <div id="tabbody-div">
