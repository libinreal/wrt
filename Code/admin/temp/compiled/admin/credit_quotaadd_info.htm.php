<!-- $Id: credit_quotaadd_info.htm 16752 2014-09-15 xy $ -->
<?php echo $this->fetch('pageheader.htm'); ?>
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,listtable.js')); ?>
<div class="main-div">
<form  action="credit_quota_add.php" method="post" enctype="multipart/form-data" id="myform" name="theForm">
<table width="100%" id="general-table">
  ...
  <tr>
    ...
    <tr>
        <td class="label"><?php echo $this->_var['lang']['contractNo']; ?>：</td>
        <td><?php echo $this->_var['info']['contractNo']; ?></td>
    </tr>
  <tr>
    <tr>
        <td class="label"><?php echo $this->_var['lang']['amount']; ?>：</td>
        <td><?php echo $this->_var['info']['amount']; ?></td>
    </tr>
    <tr>
    <tr>
        <td class="label"><?php echo $this->_var['lang']['reason']; ?>：</td>
        <td><?php echo $this->_var['info']['reason']; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td id="state">
            <span>
                <?php if ($this->_var['info']['status'] == 0): ?>
                    <?php echo $this->_var['lang']['not_deal']; ?>&nbsp;&nbsp;&nbsp;
                    <a href="javascript:void(0);" class="state_a" listid="<?php echo $this->_var['info']['id']; ?>" style="text-decoration: underline;color: red; "><?php echo $this->_var['lang']['accept_credit_quotaadd']; ?></a>
                <?php elseif ($this->_var['info']['status'] == 1): ?>
                   <?php echo $this->_var['lang']['success_credit_quotaadd']; ?>
                <?php endif; ?>
            </span>
        </td>
    </tr>
    <tr class="td-remark" <?php if ($this->_var['info']['status'] == 0): ?> style='display:none'<?php endif; ?>>
    ...
    <div class="button-div" <?php if ($this->_var['info']['status'] == 0): ?> style='display:none'<?php endif; ?>>
        ...
        <?php if ($this->_var['info']['status'] == 1): ?><input type="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" class="button" /><?php endif; ?>
    </div>
</form>
</div>
    ...
    function update_state(id,remark1){
        $.ajax({
            ...
            'success':function(msg){
                msg = $.parseJSON(msg);
                if(msg.status == 1){
                    $('#state').text('<?php echo $this->_var['lang']['success_credit_quotaadd']; ?>');
                    $('.td-remark').show();
