...
?>
            ...
            <tr>
                <td colspan="2">
                    <input name="drop_type_id" type="submit" id="btnSubmit" value="<?php echo $this->_var['lang']['drop_logs']; ?>" disabled="true" class="button" onclick="{if(confirm('您确定要删除操作日志吗？')){return true;}return false;}" />
                </td>
