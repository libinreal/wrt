...
<div class="form-div">
    <form action="javascript:searchOrder()" name="searchForm">
        ...
        <select name="status" id="status">
            <?php echo $this->html_options(array('options'=>$this->_var['status_list'],'selected'=>$this->_var['myStatus'])); ?>
        </select>
    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            <tr>
                ...
                <th><a href="javascript:listTable.sort('contract_sn', 'DESC'); "><?php echo $this->_var['lang']['contract_sn']; ?></a><?php echo $this->_var['sort_contract_sn']; ?></th>
                ...
                <th><a href="javascript:listTable.sort('order_amount', 'DESC'); "><?php echo $this->_var['lang']['total_fee']; ?></a><?php echo $this->_var['sort_total_fee']; ?></th>
                <th><a href="javascript:listTable.sort('order_status', 'DESC'); "><?php echo $this->_var['lang']['all_status']; ?></a><?php echo $this->_var['sort_order_status']; ?></th>
...
?>
            <tr>
                ...
                <td align="center" valign="top"  nowrap="nowrap">
                    ...
                    <a href="order.php?act=remarks&order_id=<?php echo $this->_var['order']['order_id']; ?>"><?php echo $this->_var['lang']['postscript']; ?></a>
                    <!--<?php if ($this->_var['order']['order_status'] == 1): ?>-->
                    <a href="order.php?act=split&order_id=<?php echo $this->_var['order']['order_id']; ?>"><?php echo $this->_var['lang']['split_orders']; ?></a>
                    <!--<?php endif; ?>-->

                    <!--<?php if ($this->_var['order']['order_status'] > 0 && $this->_var['order']['order_status'] != 5 && $this->_var['order']['order_status'] != 6): ?>-->
                    <a href="order.php?act=suborders&order_id=<?php echo $this->_var['order']['order_id']; ?>"><?php echo $this->_var['lang']['suborders']; ?></a>
                    <!--<?php endif; ?>-->
                </td>
            </tr>
                <?php endforeach; else: ?>
