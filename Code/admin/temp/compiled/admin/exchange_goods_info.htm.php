...
<div id="tabbar-div">
    <p>
        ...
        <span class="tab-back" id="linkgoods-table"><?php echo $this->_var['lang']['tab_sales']; ?></span>
        <!--
...
<!-- tab body -->
<div id="tabbody-div">
<form enctype="multipart/form-data" action="exchange_goods.php" method="post" name="theForm" onsubmit="return fnData();" >
<!-- 最大文件限制 -->
...
<table width="90%" id="general-table" align="center">
    <tr>
        ...
        <td>
            <input type="text" id="goods_name" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" style="float:left;color:<?php echo $this->_var['goods_name_color']; ?>;" size="30" />
            <!--
    ...
    <tr>
        ...
        <td><input type="text" id="shop_price" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" onblur="fnGetPrice()"/>
...
<table width="90%" id="properties-table" style="display:none">
    <tr>
        <td><?php echo $this->_var['specFCKeditor']; ?></td>
    </tr>
    <!-- <tr>
...
?>
            <div id="gallery_<?php echo $this->_var['img']['img_id']; ?>" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                ...
                <a href="exchange_goods.php?act=show_image&img_url=<?php echo $this->_var['img']['img_url']; ?>" target="_blank">
...
function fnGetPrice() {
    var p = document.getElementById('shop_price').value;
    var demo=/^\d+(.\d+)|\d$/;
    if(p=='') {
        alert('积分额度不能为空');
...
function fnData() {
    ...
    if($("#shop_price").val()<0 || $("#shop_price").val()=='') {
        alert(shop_price_not_null);
        return false;
    }
    return true;
}
...
//    }
    ...
    Ajax.call('exchange_goods.php?is_ajax=1&act=check_goods_sn', "goods_sn=" + goods_sn + "&goods_id=" + goods_id, callback, "GET", "JSON");
}
...
function getAttrList(goodsId)
{
    ...
    if (selGoodsType != undefined)
    {
        ...
        Ajax.call('exchange_goods.php?is_ajax=1&act=get_attr', 'goods_id=' + goodsId + "&goods_type=" + goodsType, setAttrList, "GET", "JSON");
    }
}
...
function addCategory()
{
    ...
    Ajax.call('exchange_category.php?is_ajax=1&act=add_category', params, addCatResponse, 'GET', 'JSON');
}
...
{
    Ajax.call('exchange_goods.php?is_ajax=1&act=drop_image', "img_id="+imgId, dropImgResponse, "GET", "JSON");
}
