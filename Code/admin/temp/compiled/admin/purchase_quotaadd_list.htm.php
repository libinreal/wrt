    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellspacing='1' cellpadding='3' id='list-table'>
            <tr>
                ...
                <th><?php echo $this->_var['lang']['purchase_quotaadd_handler']; ?></a></th>
                <th><?php echo $this->_var['lang']['handler']; ?></th>
            </tr>
            <?php $_from = $this->_var['purchase_quotaadd_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'list');if (count($_from)):
...
?>
            <tr>
                ...
                <td align="center" id="state_<?php echo $this->_var['list']['id']; ?>">
                    <span>
                        <?php if ($this->_var['list']['status'] == 0): ?>
                            <a href="javascript:void(0);" class="state_a" listid="<?php echo $this->_var['list']['id']; ?>"><?php echo $this->_var['lang']['accept_purchase_quotaadd']; ?></a>
                ...
                <td align="center" nowrap="true">
                    <span>
                        <a href="purchase_quota_add.php?act=info&comid=<?php echo $this->_var['list']['id']; ?>" title="<?php echo $this->_var['lang']['view']; ?>"><?php echo $this->_var['lang']['check_info']; ?></a>&nbsp;
                    </span>
                </td>
            </tr>
            <?php endforeach; else: ?>
            <tr><td class="no-records" colspan="10"><?php echo $this->_var['lang']['no_purchase_quotaadd']; ?></td></tr>
    ...
    function update_state(id,remark){
        $.ajax({
            ...
            'success':function(msg){
                msg = $.parseJSON(msg);
                if(msg.status == 1){
                    $('#state_'+id).text('<?php echo $this->_var['lang']['success_purchase_quotaadd']; ?>');
                    $('#remark').val('');
                }
            }
        });
