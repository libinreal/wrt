...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    <td align="left" class="first-cell nowrap" valign="top" >
      ...
      <?php endif; ?>
      <span><a href="helpcenter.php?act=list&amp;cat_id=<?php echo $this->_var['cat']['cat_id']; ?>"><?php echo htmlspecialchars($this->_var['cat']['cat_name']); ?></a></span>
    </td>
    <td class="nowrap" valign="top">
      <?php echo $this->_var['lang']['type_name'][$this->_var['cat']['cat_type']]; ?>
    </td>
    ...
    <!--<td width="24%" align="center" class="nowrap" valign="top">
      <?php if ($this->_var['cat']['cat_type'] == 4000): ?>
      ...
      <?php else: ?>
      <span><?php echo $this->_var['lang']['nohandler']; ?></span>
      <?php endif; ?>
    </td>-->
  </tr>
