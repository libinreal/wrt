...
<div class="main-div">
    <form action="category.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%" id="general-table">
            ...
            <?php if ($this->_var['form_action'] == "add"): ?>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type='text' name='code' maxlength="20" value='<?php echo htmlspecialchars($this->_var['cat_info']['code']); ?>' size='27' />
                </td>
            </tr>
            <tr>
                <td class="label"><?php echo $this->_var['lang']['wcode']; ?>:</td>
                <td>
                    <input type='text' name='wcode' maxlength="20" value='<?php echo htmlspecialchars($this->_var['cat_info']['wcode']); ?>' size='27' />
                    <br/><span class="notice-span"><?php echo $this->_var['lang']['notice_wcode']; ?></span>
                </td>
            </tr>
