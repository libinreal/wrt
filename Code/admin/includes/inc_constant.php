...
/* 积分订单状态 */
//define('OS_UNCONFIRMED',            0); // 未确认  1
//define('OS_CONFIRMED',              1); // 已确认  2
//define('OS_CANCELED',               2); // 已取消
//define('OS_INVALID',                3); // 无效
define('OS_RETURNED',               4); // 退货  积分订单
define('OS_ACCOUNT',                3); // 对账中 积分订单
...
/*  采购订单的生成应收单后的付款状态 */
define('PURCHASE_ORDER_PAY_UNMAKE', 0);//未生成
define('PURCHASE_ORDER_PAY_MAKED', 1);//已生成
define('PURCHASE_ORDER_PAY_PAID', 2);//已付款

/*  供应商的生成单付款状态 */
define('PURCHASE_ORDER_PAY_SUBMIT', 0);//已生成
define('PURCHASE_ORDER_PAY_SUCCESS', 1);//审核通过
define('PURCHASE_ORDER_PAY_RECEIVED', 2);//已付款
define('PURCHASE_ORDER_PAY_FAIL', 3);//审核不通过（驳回）

/* 支付类型 */
define('PAY_ORDER',                 0); // 订单支付
define('PAY_SURPLUS',               1); // 会员预付款
/* 配送状态 */
define('SS_UNSHIPPED',              0); // 未发货  1
define('SS_SHIPPED',                1); // 已发货  2
define('SS_RECEIVED',               2); // 已收货  3
define('SS_PREPARING',              3); // 备货中  4
define('SS_SHIPPED_PART',           4); // 已发货(部分商品)
define('SS_SHIPPED_ING',            5); // 发货中(处理分单)
define('OS_SHIPPED_PART',           6); // 已发货(部分商品)

/*  验签开关  */
define('SIGN_SWITCH_OPEN', 0);//开
define('SIGN_SWITCH_CLOSE', 1);//关
